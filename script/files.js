window.addEventListener('load', () => {
  ...
  function pleasePlay(
    ...
    for (let soundTitle of Object.keys(audios2)) {
      ...
      // if (soundTitle.lastIndexOf)
      let splittedTitle = soundTitle.split('/')[1].split('.')[0];
    ...
    buttonCancel.addEventListener('click', () => {
      document.getElementById("showDeleteBox").style.opacity = 0;
      document.getElementById("showDeleteBox").style.zIndex = 1;
      document.getElementById("showDeleteBox").style.pointerEvents = "none";
      document.getElementById("showDeleteBox").style.display = "none";
    })
  }
